<div class="col-sm-3 col-xs-6 canvasoff-left">
    <!-- 个人中心导航 -->
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    <li><a href="./borrow_apply.php">借款项目</a></li>
                    <li><a href="#">还款明细</a></li>
                    <li><a href="./borrow_list.php">我的借款</a></li>
                    <li><a href="./borrow_condition.php">借款报表情况</a></li>
                </ul>
            </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li><a href="real_name.php">实名认证</a></li>
